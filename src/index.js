...
class sql {
   ...
   * @param {*} opts The options to configure Knex (The configuration used is the one defined by NODE_ENV or 'development' if not set)
  ...
  /**
   * The migration
   * @param {String} action up, down, latest, rollback, currentVersion, list, make (By default, latest)
